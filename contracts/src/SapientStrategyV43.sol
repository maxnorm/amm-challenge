...
/// @title Sapient Strategy V43 — V34 + two-speed pHat
/// @notice Same as V34 (YQ baseline) plus: pHat_slow (slower EMA). When |pHat - pHat_slow|/pHat_slow > threshold, add a fee term (regime change).
/// @dev Unique angle 2.7 from docs/2025-02-10-V34-explanation-and-unique-angles.md. One new slot: slots[11] = pHat_slow.
contract Strategy is AMMStrategyBase {
    ...
    function _updatePhatSlowV43(uint256 pImplied) internal {
    ...
    function getName() external pure override returns (string memory) {
        return "Sapient v43 - two-speed pHat";
    }
}
