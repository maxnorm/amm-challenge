...
/// @title Sapient Strategy V11 — V10 with tuned-down flow terms + cap
/// @notice Same as V10 but LAMBDA_COEF 6 bps, FLOW_SIZE_COEF 15 bps, and total flow term capped at 12 bps to avoid overcharging in active regimes.
/// @dev See /docs/2025-02-09-Sapient-V11-tune-changelog.md
contract Strategy is AMMStrategyBase {
    ...
    /// @notice V11: V10 with LAMBDA_COEF 6 bps, FLOW_SIZE_COEF 15 bps, flow term capped at 12 bps
    ...
    function getName() external pure override returns (string memory) {
        return "Sapient v11 - (V10 tune: flow 6+15 bps, cap 12 bps)";
    }
}
