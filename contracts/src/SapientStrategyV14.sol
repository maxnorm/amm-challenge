...
/// @title Sapient Strategy V14 — Rewrite: low base + additive build-up
/// @notice Base fee = BASE_LOW + sigma + imbalance + vol + symTox; same downstream as V7 (tox, asym, dir, surge, size, cap).
/// @dev See /docs/plans/2025-02-09-rewrite-low-base-additive-design.md
contract Strategy is AMMStrategyBase {
    ...
    /// @notice V14: additive base (BASE_LOW + sigma + imb + vol + symTox) + floor + decay; same tox/asym/dir/surge/size as V7
    ...
    function getName() external pure override returns (string memory) {
        return "Sapient v14 - (rewrite: low base + additive)";
    }
}
