...
/// @title Sapient Strategy V25 — V24 with scaled activity coefficients
/// @notice Same as V24 (activity in base: lambda, flowSize, actEma) but FLOW_SIZE_COEF and ACT_COEF scaled down so activity adds ~5–20 bps total instead of hundreds. Recovers from V24 edge collapse (40).
/// @dev See docs/2025-02-10-V24-edge-40-investigation.md. YQ coefs on top of our sigma/imb/vol/symTox peg fee at 75 bps; scaled coefs keep activity meaningful but bounded.
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant LAMBDA_COEF = 12e14;     // 12 bps (unchanged)
    uint256 constant FLOW_SIZE_COEF = 300e14;  // ~16× smaller than YQ; init flowSize ~5 bps
    uint256 constant ACT_COEF = 500e14;       // ~184× smaller than YQ; 1% actEma → 5 bps
    ...
    function getName() external pure override returns (string memory) {
        return "Sapient v25 - (V24 scaled activity coefs)";
    }
}
