...
/// @title Sapient Strategy V49 — V34 + param tune #1 TAIL_KNEE 450 BPS
/// @notice Same as V34 with single constant change: TAIL_KNEE 500 -> 450 BPS (Test A).
/// @dev Param tuning procedural plan docs/2025-02-10-param-tuning-procedural-plan.md
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant TAIL_KNEE = 450 * BPS; // tune #1: was 500
