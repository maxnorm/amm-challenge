...
/// @title Sapient Strategy V17 — V14 with cap 100 bps (1%)
/// @notice Same as V14 (low base + additive) but MAX_FEE_CAP = 100 bps to test headroom vs 75–85 bps without repeating V16 (10% collapse).
/// @dev See /docs/2025-02-09-Sapient-V16-cap-10pct-changelog.md
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant MAX_FEE_CAP = 100e14;      // 100 bps (1%) — intermediate cap vs V14 (75) / V16 (10%)
    ...
    /// @notice V17: V14 with MAX_FEE_CAP = 100 bps (1%)
    ...
    function getName() external pure override returns (string memory) {
        return "Sapient v17 - (V14 cap 100 bps)";
    }
}
