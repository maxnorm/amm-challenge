...
/// @title Sapient Strategy V34 — YQ baseline (from-scratch)
/// @notice Minimal YQ-aligned clone: 3 bps base + sigma + lambda + flowSize; pImplied; first-in-step; dirState; stale/attract; tail compression.
/// @dev See docs/2025-02-10-from-scratch-reverse-engineer-and-design.md. Source: refs/YQStrategy.sol.
