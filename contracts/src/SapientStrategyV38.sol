...
/// @title Sapient Strategy V38 — V34 + calm vs stressed (tighter thresholds)
/// @notice Same as V36 but tighter calm: sigma <= 0.5% and tox <= 1% (calm less often, stressed bump more often).
/// @dev See docs/2025-02-10-Sapient-V38-calm-tighter-changelog.md.
contract Strategy is AMMStrategyBase {
    ...
    // --- Calm vs stressed: TIGHTER thresholds (calm less often) vs V36 ---
    uint256 constant CALM_SIGMA_THRESH = 5e15;   // 0.5% (V36 was 1%)
    uint256 constant CALM_TOX_THRESH = 1e16;     // 1% (V36 was 2%)
    ...
    function afterSwap(TradeInfo calldata trade) external override returns (uint256, uint256) {
        ...
        // Calm vs stressed (tighter thresholds): calm less often => more stressed bump
        {
    ...
    function getName() external pure override returns (string memory) {
        return "Sapient v38 - calm vs stressed (tighter thresh)";
    }
}
