...
/// @title Sapient Strategy V31 — V28 (pHat fix) + V26 scaled activity coefs
/// @notice V28 (pHat fix, activity zeroed) still 40.30. Re-enable scaled activity (LAMBDA 2e14, FLOW_SIZE 300e14, ACT 500e14) on top of pHat fix.
/// @dev Same pipeline as V28; only activity coefficients restored from V26.
contract Strategy is AMMStrategyBase {
    ...
    uint256 constant LAMBDA_COEF = 2e14;      // V26 scaled: max 10 bps from lambda
    uint256 constant FLOW_SIZE_COEF = 300e14;
    uint256 constant ACT_COEF = 500e14;
    ...
    function getName() external pure override returns (string memory) {
        return "Sapient v31 - (V28 + V26 activity coefs)";
    }
}
